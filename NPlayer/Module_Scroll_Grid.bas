Attribute VB_Name = "Module_Scroll_Grid"
'Option Explicit
...
Dim objForm As Form_Principal
   On Error GoTo errorHandler
    ...
    'If the flexGrid is the active control then
     If TypeOf Form_Principal.ActiveControl Is MSFlexGrid Then
        ' ##### Scroll direction #####
    ...
    Else
        ...
        WndProc = CallWindowProc(GetProp(Form_Principal.hwnd, "PrevWndProc"), hwnd, uMsg, wParam, lParam)
    End If
    Exit Function
errorHandler:
...
'
Public Function PtrToForm(ByVal lPtr As Long) As Form_Principal
Dim obj As Form_Principal
